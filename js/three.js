...
//   renderer.setPixelRatio(window.devicePixelRatio / 2); /// 4
...
//   let effectFilm = new THREE.FilmPass(10.0, 0.5, 20.0, false);//0.8, 0.325, 256, false   0.2, 0.005, 0.001, false
//   // let effectFilm = new THREE.FilmPass(4.0, 0.0005, 0.007, false);
...
//     (window.innerWidth, greetings.clientHeight, 250, 180);; //(16, 16, 50, 50);
//     var geometryLine = new THREE.PlaneBufferGeometry
//     (window.innerWidth, greetings.clientHeight, 250, 0);; //(16, 16, 50, 50);
//   var materialLines = new THREE.MeshNormalMaterial({wireframe: true});
//   var linesModel = new THREE.Mesh(geometryLine, materialLines);
//   geometry.verticesNeedUpdate = true;


//   // var geometry = new THREE.PlaneBufferGeometry
//   //   (window.innerWidth, greetings.clientHeight + 200, 250, 180);; //(16, 16, 50, 50);
...
//       texture: {
//         type: "t",
//         value: THREE.ImageUtils.loadTexture(templateUrl + '/js/assets/texture-bw.jpg')//rainbow-aqua
//       },
...
//       resolution: {
//         type: "vec2",
//         value: { x: window.innerWidth, y: greetings.clientHeight }, //0.09 for normal wobble
//       },
//       mouse: {
//         type: "vec2",
...
//   model.position.z -= 500;//450
//   linesModel.position.z -= 550;//450
//   scene.add(model);
//   scene.add(linesModel);
//   console.log(model.material.uniforms['resolution'].value)
...
//   model.material.uniforms['mouse'].value.y = 1.3 - (e.pageY / greetings.clientHeight);


//   // const rect = greetings.getBoundingClientRect();
//   // model.material.uniforms['mouse'].value.x = e.clientX - rect.left;
//   // model.material.uniforms['mouse'].value.y = rect.height - (e.clientY - rect.top) - 1;
//   // console.log( model.material.uniforms['mouse'].value.x)
//   // console.log(model.geometry.attributes.position.array);
//   // console.log(model.material.uniforms['mouse'].value.y)
